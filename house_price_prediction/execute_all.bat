...
echo ==========================================================
echo Executing %~dp0src\models\6.0_train_model.py
python %~dp0src\models\6.0_train_model.py
echo Execution of %~dp0src\models\6.0_train_model.py completed
echo ==========================================================
echo Executing %~dp0notebooks\7.0_Explore_base_model_results.py
python %~dp0notebooks\7.0_Explore_base_model_results.py
echo Execution of %~dp0notebooks\7.0_Explore_base_model_results.py completed
echo ==========================================================
echo Executing %~dp0src\models\8.0_predict_model.py
python %~dp0src\models\8.0_predict_model.py
echo Execution of %~dp0src\models\8.0_predict_model.py completed
echo ==========================================================
